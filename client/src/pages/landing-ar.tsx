...
const STEPS = [
  {
    icon: Boxes,
    title: "ختار المنتج",
    text: "تصفّح الكاطالوگ ديالنا، شوف الثمن ديال الجملة والربح المتوقع، وطلب الإذن باش تبيعو.",
  },
  {
    icon: Zap,
    title: "بيع بلا ستوك",
    text: "ربّط الستور ديالك مع يوكان، شوپيفاي، ووكومرس ولا گوگل شيت. الطلبات كايوصلو ليك أوتوماتيك.",
  },
  {
    icon: PackageCheck,
    title: "حنا كانكملو كولشي",
    text: "تأكيد الطلبات، التغليف والتوصيل — كولشي علينا. نتا غير ركّز على الإشهار.",
  },
];
...
const FAQ = [
  {
    ...
    a: "لا. المنتجات عندنا فالمستودع. نتا كتبيع، وحنا كانغلّفو وكانوصّلو. ما كتخلّصش المنتج حتى توصل الطلبية للكليان.",
  },
  {
    q: "شحال كانخلّص؟",
    a: "كتخلّص غير على الطلبات اللي توصلات: ثمن المنتج، التوصيل، التغليف والتأكيد. الطلبية اللي ما توصلاتش ما كتكلّفك والو.",
  },
  {
    q: "كيفاش كانوصل ليّا الفلوس؟",
    a: "كل طلبية توصلات كيتحسب الربح ديالها فالفاكتورة ديالك. الخلاص كيتم بشكل دوري على حساب الفاكتورات.",
  },
  {
    q: "واش خاصني ستور أونلاين؟",
    a: "ماشي ضروري. تقدر تدخل الطلبات بيدك ولا تجيبهم من فيشي إكسيل. وإلا عندك ستور، ربطو ف دقيقة.",
  },
  {
    q: "شحال كياخد باش نبدا؟",
            ...
            <Reveal>
              <div>
                ...
                <p className="mt-5 max-w-xl text-lg leading-relaxed text-white/70">
                  ختار المنتج من الكاطالوگ ديالنا، سوّق ليه، وحنا كانتكلّفو بتأكيد الطلبات،
                  التغليف والتوصيل لجميع المدن. نتا غير كتبيع.
                </p>
                ...
                <div className="mt-10 grid max-w-lg grid-cols-3 gap-6">
                  {[
                    { n: null as any, t: "جميع المدن", l: "التغطية ديال التوصيل" },
                    { n: 24, s: "/7", t: null, l: "تتبّع الطلبات" },
                    { n: 0, s: " درهم", t: null, l: "راس مال ديال البداية" },
                  ].map((k) => (
                    <div key={k.l}>
                      <p className="text-2xl font-extrabold md:text-3xl" style={{ color: GOLD }}>
                        {/* Une entree peut porter un texte au lieu d'un nombre :
                            « جميع المدن » ne s'anime pas comme un compteur. */}
                        {k.t ? k.t : <Counter to={k.n!} suffix={k.s} />}
                      </p>
          ...
          <Reveal delay={120}>
            <div className="mt-12 overflow-hidden rounded-2xl border-2" style={{ borderColor: GOLD }}>
              <div className="p-8 text-center" style={{ background: NAVY }}>
                ...
                <p className="mt-2 text-white/60">خلّص غير التكاليف ديال الطلبات الموصّلة</p>
              </div>

              <div className="grid gap-px bg-slate-200 sm:grid-cols-3">
                {[
                  { l: "تأكيد الطلبات", v: "10 د.م", d: "لكل طلبية موصّلة" },
                  { l: "التغليف", v: "6 د.م", d: "لكل طلبية موصّلة" },
              ...
              <div className="bg-white px-8 pb-8 pt-2 text-center">
                <p className="text-sm text-slate-500">
                  الطلبية اللي ما توصلاتش ما كتخلّص عليها والو — لا تأكيد، لا توصيل، لا تغليف.
                </p>
                <Link
                  href="/tajerdrop-inscription"
        ...
        <Reveal>
          <div className="relative mx-auto max-w-3xl px-5 text-center">
            ...
            <p className="mt-4 text-lg text-white/70">
              التسجيل مجاني وكياخد غير دقيقة. ما خاصك لا ستوك لا رأس مال.
            </p>
            <Link
              href="/tajerdrop-inscription"
