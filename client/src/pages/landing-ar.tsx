...
const STEPS = [
  ...
  },
  {
    icon: Zap,
    title: "بيع بلا ستوك",
    text: "ربّط الحانوت ديالك مع يوكان، شوپيفاي، ووكومرس ولا گوگل شيت. الكوموندات كايوصلو ليك أوتوماتيك.",
  },
  {
    icon: PackageCheck,
    title: "حنا كانكملو كولشي",
    text: "التأكيد فالتيليفون، التغليف، والتوصيل — كولشي علينا. نتا غير ركّز على الإشهار.",
  },
];

const FEATURES = [
  { icon: Headphones, title: "سونطر ديال التأكيد", text: "فريق مغربي كايعيّط على الكليان بالدارجة ويأكّد الكوموندات ديالك." },
  { icon: Truck, title: "توصيل فكامل المغرب", text: "شركاء توصيل كايغطّيو أكثر من 60 مدينة، مع تتبّع مباشر لكل كولي." },
  { icon: Wallet, title: "الخلاص عند التوصيل", text: "ما كتخلّصش والو حتى توصل الكوموندا. لا ستوك، لا مخاطرة." },
...
const FAQ = [
  {
    ...
    a: "لا. المنتجات عندنا فالمستودع. نتا كتبيع، وحنا كانغلّفو وكانوصّلو. ما كتخلّصش المنتج حتى توصل الكوموندا للكليان.",
  },
  {
    q: "شحال كانخلّص؟",
    a: "كتخلّص غير على الكوموندات اللي توصلات: ثمن المنتج، التوصيل، التغليف والتأكيد. الكوموندا اللي ما توصلاتش ما كتكلّفك والو.",
  },
  {
    q: "كيفاش كانوصل ليّا الفلوس؟",
    a: "كل كوموندا توصلات كيتحسب الربح ديالها فالفاكتورة ديالك. الخلاص كيتم بشكل دوري على حساب الفاكتورات.",
  },
  {
    q: "واش خاصني حانوت أونلاين؟",
    a: "ماشي ضروري. تقدر تدخل الكوموندات بيدك ولا تجيبهم من فيشي إكسيل. وإلا عندك حانوت، ربطو ف دقيقة.",
  },
  {
            ...
            <Reveal>
              <div>
                ...
                <p className="mt-5 max-w-xl text-lg leading-relaxed text-white/70">
                  ختار المنتج من الكاطالوگ ديالنا، سوّق ليه، وحنا كانتكلّفو بتأكيد الكوموندات
                  فالتيليفون، التغليف والتوصيل فكامل المغرب. نتا غير كتبيع.
                </p>
                ...
                <div className="mt-10 grid max-w-lg grid-cols-3 gap-6">
                  {[
                    ...
                    { n: 0, s: " درهم", l: "راس مال ديال البداية" },
                  ].map((k) => (
                    <div key={k.l}>
            ...
            <div className="mt-12 overflow-hidden rounded-2xl border-2" style={{ borderColor: GOLD }}>
              ...
              <div className="grid gap-px bg-slate-200 sm:grid-cols-3">
                {[
                  ...
                  { l: "التغليف", v: "6 د.م", d: "لكل كوموندا موصّلة" },
              ...
              <div className="bg-white px-8 pb-8 pt-2 text-center">
                <p className="text-sm text-slate-500">
                  الكوموندا اللي ما توصلاتش ما كتخلّص عليها والو — لا تأكيد، لا توصيل، لا تغليف.
                </p>
                <Link
                  href="/tajerdrop-inscription"
