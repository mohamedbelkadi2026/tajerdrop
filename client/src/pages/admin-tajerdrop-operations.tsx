...
function Stat({ icon: Icon, label, value, detail }: { icon: any; label: string; value: string; detail: string }) {
  return <div className="rounded-xl border p-4" style={{ background: "rgba(255,255,255,.045)", borderColor: "rgba(255,107,53,.18)" }}>
